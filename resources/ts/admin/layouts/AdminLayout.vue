        ...
        <ul class="space-y-2">
          ...
          <li>
            <RouterLink
              ...
              class="flex items-center px-4 py-2 hover:bg-primary-foreground/10"
              :class="{
                'bg-primary-foreground/10': isActive('/admin/items'),
              }"
            >
          ...
          <li>
            <RouterLink
              ...
              class="flex items-center px-4 py-2 hover:bg-primary-foreground/10"
              :class="{
                'bg-primary-foreground/10': isActive('/admin/categories'),
              }"
            >
          ...
          <li>
            <RouterLink
              ...
              class="flex items-center px-4 py-2 hover:bg-primary-foreground/10"
              :class="{
                'bg-primary-foreground/10': isActive('/admin/users'),
              }"
            >
          ...
          <li>
            <RouterLink
              ...
              class="flex items-center px-4 py-2 hover:bg-primary-foreground/10"
              :class="{
                'bg-primary-foreground/10': isActive('/admin/claims'),
              }"
            >
          ...
          <li>
            <RouterLink
              ...
              class="flex items-center px-4 py-2 hover:bg-primary-foreground/10"
              :class="{
                'bg-primary-foreground/10': isActive('/admin/settings'),
              }"
            >
