<template>
    <WebsiteLayout>
        <div class="container py-8 px-20">
            <div class="mb-8">
                <h1 class="text-3xl font-bold mb-2">Itens Perdidos</h1>
                <p class="text-muted-foreground">
                    Confira os itens reportados como perdidos em nosso
                    município. Se você encontrou algum destes itens, entre em
                    contato para ajudar a devolvê-lo ao seu dono.
                </p>
            </div>
...
const paginationItems = computed(() => {
    ...
    if (totalPages.value <= maxVisiblePages) {
        ...
        // Lógica para mostrar "..." quando tem muitas páginas
    ...
    try {
        ...
        const mockItems = [
            ...
            },
            {
                ...
                description:
                    "Guarda-chuva automático azul marinho, perdido no Shopping Central.",
                status: "perdido",
