    ...
    <div class="container py-8 px-20">
      <div class="mb-8">
        ...
        <p class="text-muted-foreground">
          Confira os itens reportados como perdidos em nosso município. Se você
          encontrou algum destes itens, entre em contacto para ajudar a
          devolvê-lo ao seu dono.
        </p>
      </div>
...
const fetchItems = async () => {
  ...
  try {
    ...
    const { data } = await itemService.getLost(params);
